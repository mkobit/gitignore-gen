...
Example usage:
  ...
  gitfiles-gen gitignore search Python

  # Generate a gitignore file
  gitfiles-gen gitignore generate Python macOS --output .gitignore
...
logger = logging.getLogger("gitfiles-gen")
...
def _get_default_cache() -> Path:
    ...
    if xdg_cache:
        return Path(xdg_cache) / "gitfiles-gen"
    return home / ".cache" / "gitfiles-gen"
